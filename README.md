...
- **Abmelden** (❌) — Unregister squad/caster/tentative with confirmation. Player-mode second action: clicking while not registered toggles a **declined** ("not attending") mark, shown as the last embed section
